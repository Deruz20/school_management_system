    ...
    <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col h-screen shrink-0 sticky top-0">
      ...
      <div className="flex-1 overflow-y-auto py-4">
        <nav className="space-y-1 px-3">
          ...
          <Link href="/finance/payroll" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 hover:text-white transition-colors">
            <Banknote size={20} />
          ...
          <Link href="/finance/assets" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 hover:text-white transition-colors">
            <Building2 size={20} />
